...
STA2="ps4-hen-1100-vtx.bin"
HDIR="/boot/firmware/PPPwn/vx_sta/"
if [ $UGH = true ] && [[ $FIRMWAREVERSION == "9.00" ]] || [[ $FIRMWAREVERSION == "9.60" ]] || [[ $FIRMWAREVERSION == "10.00" ]] || [[ $FIRMWAREVERSION == "10.01" ]] || [[ $FIRMWAREVERSION == "10.50" ]] || [[ $FIRMWAREVERSION == "10.70" ]] || [[ $FIRMWAREVERSION == "10.71" ]] || [[ $FIRMWAREVERSION == "11.00" ]] ; then
HDIR="/boot/firmware/PPPwn/gh_sta/"
STA2="stage2_${FIRMWAREVERSION}.bin"
else
UGH=false
STA2="ps4-hen-${FIRMWAREVERSION//.}-vtx.bin"
fi
